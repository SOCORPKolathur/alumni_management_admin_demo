...
import '../Donation_fireCurd/donation_firecrud.dart';
...
class _DonationsTabState extends State<DonationsTab> {
  ...
  TextEditingController bankController = TextEditingController(text: "Select Type");
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      child: Padding(
        padding: EdgeInsets.symmetric(vertical: height/81.375, horizontal: width/60),
                                ...
                                InkWell(
                                  onTap: () async {
                                    ...
                                    if (amountController.text != "" && amountController.text != "0" &&
                                        ...
                                        viaController.text != "" &&
                                        dateController.text != "" &&
                                        sourceController.text != "" && bankController.text != "Select Type") {
                                      Response response =
                                            ...
                                            onConfirmBtnTap: () async {
                                             ...
                                             /* await generateDonationPdf(
                                              ...
                                              setState(() {
                                                currentTab = 'View';
                                                verifierController.text != "";
                                                bankController.text = "Select Type";
                                                descriptionController.text = "";
