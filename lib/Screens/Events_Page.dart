...
class _EventsTabState extends State<EventsTab>
  ...
  doclength() async {
    try {
      ...
      final cf.QuerySnapshot result =
          await cf.FirebaseFirestore.instance.collection("Batch_events").get();
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    children: [
                                      ...
                                      Padding(
                                        padding:
                                            EdgeInsets.only(top: height / 7.39),
                                        child: Row(
                                          mainAxisAlignment:
                                                              ...
                                                              padding:
                                                                  const EdgeInsets
                                                                      ...
                                                                      left:
                                                                          8.0),
                                                              child: Text(
                                                                  'Title should contain at least one alphabet !!',
                                                                  style: SafeGoogleFont(
                                                                      'Poppins',
                                                                      color: Colors
                                                                          .black)),
                        ...
                        ? Column(
                            children: [
                              ...
                              SizedBox(
                                ...
                                width: width / 1.2288,
                                child: StreamBuilder(
                                  stream: EventsFireCrud.fetchEventsWithFilter(
                                    ...
                                    if (snapshot.hasError) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount: pagecount == temp
                                            ? events.length.remainder(10) == 0
                                                ? 10
                                                : events.length.remainder(10)
                                            : 10,
                                        itemBuilder: (ctx, i) {
                                          return SizedBox(
                                              width: width / 1.2288,
                                                                  ...
                                                                  children: [
                                                                    SizedBox(
                                                                      ...
                                                                      child:
                                                                          Padding(
                                                                        padding:
                                                                            EdgeInsets.only(left: width / 192),
                                                                        child:
                                                                            KText(
                                                                          text:
                                                                              "${((temp * 10) - 10 + i) + 1}",
                                                                    ...
                                                                    Container(
                                                                        ...
                                                                        decoration:
                                                                          ...
                                                                          color: Colors
                                                                              ...
                                                                              .shade300,
                                                                          borderRadius:
                                                                              BorderRadius.circular(19.5553703308 * fem),
                                                                          image:
                                                                              DecorationImage(
                                                                            fit:
                                                                                BoxFit.cover,
                                                                            image:
                                                                                NetworkImage(events[i].imgUrl.toString()),
                                                                          ),
                                                                        ),
                                                                        child: Center(
                                                                            child: events[i].imgUrl.toString() == ""
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: KText(
                                                                                text: event.registeredUsers!.length.toString(),
                                                                                style: SafeGoogleFont(
                                                                                  'Nunito',
    ...
    await showMenu(
      ...
      items: exportDataList
          .map((item) => PopupMenuItem<String>(
                ...
                onTap: () async {
                  if (item == "Print") {
                    var data = await generateEventPdf(
                        PdfPageFormat.letter, events, false);
                  } else if (item == "Copy") {
  ...
  viewregisteredusers(List<String> userdocid) async {
    Size size = MediaQuery.of(context).size;
