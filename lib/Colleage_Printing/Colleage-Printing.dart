...
Future<Uint8List> generateActivityPdf(PdfPageFormat pageFormat,List<ColleageActivityModel> ActvityList ,bool isPdf) async {

  final event = JobPosttModelforPdf(
      title: "Products",
      Activity: ActvityList
  );
...
class JobPosttModelforPdf{
  ...
  JobPosttModelforPdf({required this.title, required this.Activity});
  String? title;
  List<ColleageActivityModel> Activity = [];
        ...
        Activity.length,
          ...
          tableHeaders.length,
            ...
            // width: 60,
              ...
              child:  pw.Center(child:pw.Text(Activity[row].getIndex(col,row),style: pw.TextStyle()),)
          ),
        ),
      ),
    );
